...
- [ ] Ввести типизированный формат ошибок Rust → TypeScript: код, понятное
...
- [ ] Разделить **Save**, **Save As** и **Export**.
- [ ] `Ctrl/Cmd+S`, Save As и предупреждение при закрытии dirty-документа.
- [ ] Atomic write через временный файл и rename.
- [ ] Ошибка записи не повреждает существующий файл.
- [ ] Recent files и проверка доступности исходного пути.
- [ ] Тесты ошибки записи и повторного сохранения.
